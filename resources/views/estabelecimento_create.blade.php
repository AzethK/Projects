...
<div class="container">
  <h2 class="text-center">Cadastrar Estabelecimento</h2>
  <br>
  <form action = "/createEstabelecimento" method = "post" class="form-group" style="width:70%; margin-left:15%;" action="/action_page.php">
